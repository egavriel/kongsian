(function() {
  ...
  const DICTIONARY = {
    en: {
      ...
      "belum ada partnership.": "No partnerships yet.",
      "undang partner dulu": "Invite partner first",
      ...
      "laporan & tagihan mingguan": "Weekly Report & Invoice",
      "pilih partner cafe": "Select Partner Cafe",
      "pilih siklus mingguan": "Select Weekly Cycle",
      "pilih partner terlebih dahulu": "Select a partner first",
      "preview laporan settlement": "Settlement Report Preview",
      "riwayat settlement": "Settlement History",
      "menghitung settlement…": "Calculating settlement...",
      "menghitung settlement...": "Calculating settlement...",
      "gagal memuat data penjualan untuk siklus ini.": "Failed to load sales data for this cycle.",
      "gagal memuat settlements.": "Failed to load settlements.",
      "rincian harian": "Daily Breakdown",
      "tagihan ke partner": "Invoice to Partner",
      "copy text": "Copy Text",
      "kirim wa": "Share on WA",
      "laporan di-copy ke clipboard ✓": "Report copied to clipboard ✓",
    ...
    id: {
      // Settlement Preview Report
      "settlements": "Settlements",
      "weekly settlement": "Settlement Mingguan",
      "laporan & tagihan mingguan": "Laporan & Tagihan Mingguan",
      "pilih partner cafe": "Pilih Partner Cafe",
      "pilih siklus mingguan": "Pilih Siklus Mingguan",
      "pilih partner terlebih dahulu": "Pilih partner terlebih dahulu",
      "preview laporan settlement": "Preview Laporan Settlement",
      "riwayat settlement": "Riwayat Settlement",
      "menghitung settlement…": "Menghitung settlement…",
      "menghitung settlement...": "Menghitung settlement…",
      "gagal memuat data penjualan untuk siklus ini.": "Gagal memuat data penjualan untuk siklus ini.",
      "gagal memuat settlements.": "Gagal memuat settlements.",
      "rincian harian": "Rincian Harian",
      "tagihan ke partner": "Tagihan ke Partner",
      "copy text": "Copy Text",
      "kirim wa": "Kirim WA",
      "laporan di-copy ke clipboard ✓": "Laporan di-copy ke clipboard ✓",
      "belum dimulai": "Belum Dimulai",
      "kosong": "Kosong",
      "preview": "Preview",
      "total omzet": "Total Omzet",
      "total item": "Total Item",
      "items terjual": "items terjual",
      ...
      "belum ada partnership.": "Belum ada partnership.",
      "undang partner dulu": "Undang partner dulu",
